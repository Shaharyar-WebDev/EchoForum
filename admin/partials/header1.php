  Navbar
<nav class="sticky top-0 bg-gray-200 border border-gray-300 dark:bg-dark-900 shadow-md p-2 flex justify-between items-center z-50">
    <!-- Left: Logo & Branding -->
...
<div class="relative group">
 ...
 <button class="btn btn-ghost btn-circle avatar">
    <div class="w-10 h-10 rounded-full border border-gray-300 dark:border-gray-600 overflow-hidden">
      ...
      <img src="http://127.0.0.1/echoforum/public/uploads/avatars/<?php echo $_SESSION['avatar'] ?>" alt="User" id="userProfile" class="w-full h-full object-cover">
      <?php else: ?>
        <img src="http://127.0.0.1/echoforum/public/uploads/avatars/agent.png" alt="User" class="w-full h-full object-cover">
      <?php endif; ?>
    </div>
  </button>
  <?php if(isset($_SESSION['user_id'])): ?>
