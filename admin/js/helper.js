...
const createCard = (
  ...
  const createHeader = (
    ...
    summaryUserImg.src =
      `http://127.0.0.1/echoforum/public/uploads/avatars/${avatar}`;
  ...
  const createImg = (img) => {
    ...
    postImg.src = `http://localhost/echoforum/public/uploads/threadPosts/${img}`;
...
const createIndCard = (
  ...
  const createImg = (img) => {
    ...
    postImg.id = "upload";
    postImg.className = "w-full h-auto object-cover mt-2 rounded-lg";
    postImg.src = `http://localhost/echoforum/public/uploads/${img}`;
    postImg.style.display = "none";
    postImg.loading = "lazy";
